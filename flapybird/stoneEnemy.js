...
Mario.StoneEnemy = function(world, x, y) {
    this.Image = Enjine.Resources.Images["stone"];
    this.World = world;
    this.X = x;
    this.Y = y;
    this.PicWidth = 48;
...
Mario.StoneEnemy.prototype = new Mario.Enemy();

Mario.StoneEnemy.prototype.Move = function() {
    var i = 0, xd = 0;
    if (this.DeadTime > 0) {
        this.DeadTime--;
