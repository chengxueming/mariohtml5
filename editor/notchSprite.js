...
Mario.NotchSprite.prototype.Draw = function(context, camera) {
    ...
    myContext.DrawClipImage(this.Image, xPixel, yPixel, this.PicWidth / 2, this.PicHeight / 2, this.XPic * this.PicWidth, this.YPic * this.PicHeight, this.PicWidth, this.PicHeight);
    context.restore();
...
Mario.NotchSprite.prototype.Update = function(delta) {
    ...
    this.YOld = this.Y;
    this.Tick++;
    if (this.__proto__.hasOwnProperty("Trigger")) {
...
Mario.NotchSprite.prototype.SubCollideCheck = function(other) {
    //xD > 0 right; yD > 0 up;
    var left1 = this.X - this.Width,
        left2 = other.X - other.Width;
    var right1 = (this.X + this.Width),
        right2 = (other.X + other.Width);
    var bottom1 = this.Y,
        bottom2 = other.Y;
    var top1 = (this.Y + this.Height),
        top2 = other.Y + other.Height;
    if (bottom1 > top2) {
        return false;
    }
    if (top1 < bottom2) {
