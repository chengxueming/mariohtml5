...
Mario.LevelMap = function(difficulty, type) {
...
Mario.LevelMap.prototype = new Enjine.GameState();

Mario.LevelMap.prototype.Enter = function() {
...
Mario.LevelMap.prototype.Exit = function() {
...
Mario.LevelMap.prototype.CheckShellCollide = function(shell) {
    this.ShellsToCheck.push(shell);
};

Mario.LevelMap.prototype.CheckFireballCollide = function(fireball) {
    this.FireballsToCheck.push(fireball);
};

Mario.LevelMap.prototype.Update = function(delta) {
...
Mario.LevelMap.prototype.Draw = function(context) {
    var i = 0, time = 0, t = 0;
...
Mario.LevelMap.prototype.DrawStringShadow = function(context, string, x, y) {
...
Mario.LevelMap.prototype.RenderBlackout = function(context, x, y, radius) {
    if (radius > 320) {
        return;
    }
...
Mario.LevelMap.prototype.AddSprite = function(sprite) {
    this.Sprites.Add(sprite);
};

Mario.LevelMap.prototype.RemoveSprite = function(sprite) {
    this.Sprites.Remove(sprite);
};

Mario.LevelMap.prototype.Bump = function(x, y, canBreakBricks) {
...
Mario.LevelMap.prototype.BumpInto = function(x, y) {
...
Mario.LevelMap.prototype.CheckForChange = function(context) {
